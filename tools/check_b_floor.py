...
# 목록이 짧으면 보류한 응답을 "보류 안 함"으로 잡는다. 실제로 2026-09-17에
# "명시되어 있지 않습니다"라고 답한 17건이 그렇게 잡혀서, 하마터면 판정이 환각을
# 놓친 것으로 오진할 뻔했다. 모델이 실제로 쓴 표현을 보고 채웠다.
ABSTAIN_HINTS = ["확인할 수 없", "알 수 없", "포함되어 있지 않", "언급되어 있지 않",
                 "나와 있지 않", "찾을 수 없", "제시되어 있지 않", "제시되지 않",
                 "명시되어 있지 않", "명시하고 있지 않", "나타나 있지 않",
                 "나타나지 않", "밝히지 않", "답할 수 없", "판단할 수 없",
                 "도출할 수 없", "없습니다"]
